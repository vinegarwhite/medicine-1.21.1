...
import com.medicine.item.custom.food.AppleSoda;
import com.medicine.item.custom.food.CannedCoke;
import com.medicine.item.custom.food.MedicineFoodItem;
import com.medicine.item.custom.food.OrangeSoda;
...
public class MedicineItems {
    ...
    // 药物
    public static final Item ALPHA_PILL = registerItems("alpha_pill", new Item(new Item.Settings().food(MedicineFoodComponents.MEDICINE_PILL)));
    public static final Item BETA_PILL = registerItems("beta_pill", new Item(new Item.Settings().food(MedicineFoodComponents.MEDICINE_PILL)));
    public static final Item GAMMA_PILL = registerItems("gamma_pill", new Item(new Item.Settings().food(MedicineFoodComponents.MEDICINE_PILL)));
    public static final Item DELTA_PILL = registerItems("delta_pill", new Item(new Item.Settings().food(MedicineFoodComponents.MEDICINE_PILL)));
    public static final Item SLEEPING_PILLS = registerItems("sleeping_pills", new Item(new Item.Settings().food(MedicineFoodComponents.MEDICINE_PILL)));
    public static final Item COLD_MEDICINE = registerItems("cold_medicine", new Item(new Item.Settings().food(MedicineFoodComponents.MEDICINE_PILL)));
    public static final Item HEADACHE_PILLS = registerItems("headache_pills", new Item(new Item.Settings().food(MedicineFoodComponents.MEDICINE_PILL)));
    public static final Item PAIN_KILLERS = registerItems("pain_killers", new Item(new Item.Settings().food(MedicineFoodComponents.MEDICINE_PILL)));
    public static final Item VITAMIN_TABLETS = registerItems("vitamin_tablets", new Item(new Item.Settings().food(MedicineFoodComponents.MEDICINE_PILL)));
    public static final Item STOMACH_MEDICINE = registerItems("stomach_medicine", new Item(new Item.Settings().food(MedicineFoodComponents.MEDICINE_PILL)));
    public static final Item AMPHETAMINE = registerItems("amphetamine", new Item(new Item.Settings().food(MedicineFoodComponents.MEDICINE_PILL)));
    public static final Item ETIZOLAM = registerItems("etizolam", new Item(new Item.Settings().food(MedicineFoodComponents.MEDICINE_PILL)));
    public static final Item ASPIRIN = registerItems("aspirin", new Item(new Item.Settings().food(MedicineFoodComponents.MEDICINE_PILL)));
    public static final Item PROPOXYPHENE = registerItems("propoxyphene", new Item(new Item.Settings().food(MedicineFoodComponents.MEDICINE_PILL)));
    public static final Item RITALIN = registerItems("ritalin", new Item(new Item.Settings().food(MedicineFoodComponents.MEDICINE_PILL)));
    public static final Item ANTI_BIOTICS = registerItems("anti_biotics", new Item(new Item.Settings().food(MedicineFoodComponents.MEDICINE_PILL)));
    public static final Item ANTI_DEPRESSANTS = registerItems("anti_depressants", new Item(new Item.Settings().food(MedicineFoodComponents.MEDICINE_PILL)));
    public static final Item PLACEBO = registerItems("placebo", new Item(new Item.Settings().food(MedicineFoodComponents.MEDICINE_PILL)));

    // 食物
    public static final Item APPLE_SODA = registerItems("apple_soda", new AppleSoda(new Item.Settings().food(MedicineFoodComponents.MEDICINE_FOOD)));
    public static final Item ORANGE_SODA = registerItems("orange_soda", new OrangeSoda(new Item.Settings().food(MedicineFoodComponents.MEDICINE_FOOD)));
    public static final Item CANNED_COKE = registerItems("canned_coke", new CannedCoke(new Item.Settings().food(MedicineFoodComponents.MEDICINE_FOOD)));
    public static final Item THICK_EGG_TOAST = registerItems("thick_egg_toast", new MedicineFoodItem(new Item.Settings().food(MedicineFoodComponents.MEDICINE_FOOD)));
    public static final Item POUR_OVER_COFFEE = registerItems("pour_over_coffee", new MedicineFoodItem(new Item.Settings().food(MedicineFoodComponents.MEDICINE_FOOD)));
    public static final Item VEGGIE_SALAD = registerItems("veggie_salad", new MedicineFoodItem(new Item.Settings().food(MedicineFoodComponents.MEDICINE_FOOD)));
    public static final Item SAUSAGE_PIZZA = registerItems("sausage_pizza", new MedicineFoodItem(new Item.Settings().food(MedicineFoodComponents.MEDICINE_FOOD)));
    public static final Item BEEF_BURGER = registerItems("beef_burger", new MedicineFoodItem(new Item.Settings().food(MedicineFoodComponents.MEDICINE_FOOD)));
    public static final Item CAESAR_BREAD = registerItems("caesar_bread", new MedicineFoodItem(new Item.Settings().food(MedicineFoodComponents.MEDICINE_FOOD)));
    public static final Item TOMATO_PASTA = registerItems("tomato_pasta", new MedicineFoodItem(new Item.Settings().food(MedicineFoodComponents.MEDICINE_FOOD)));
    public static final Item SALMON_SOUP = registerItems("salmon_soup", new MedicineFoodItem(new Item.Settings().food(MedicineFoodComponents.MEDICINE_FOOD)));
    public static final Item TOMAHAWK_STEAK = registerItems("tomahawk_steak", new MedicineFoodItem(new Item.Settings().food(MedicineFoodComponents.MEDICINE_FOOD)));
    public static final Item BAGGED_CHESTNUTS = registerItems("bagged_chestnuts", new MedicineFoodItem(new Item.Settings().food(MedicineFoodComponents.MEDICINE_FOOD)));
    public static final Item FRIED_CRISPY_MEAT = registerItems("fried_crispy_meat", new MedicineFoodItem(new Item.Settings().food(MedicineFoodComponents.MEDICINE_FOOD)));
    public static final Item GRILLED_COLD_NOODLES = registerItems("grilled_cold_noodles", new MedicineFoodItem(new Item.Settings().food(MedicineFoodComponents.MEDICINE_FOOD)));
    public static final Item PINEAPPLE_ON_A_STICK = registerItems("pineapple_on_a_stick", new MedicineFoodItem(new Item.Settings().food(MedicineFoodComponents.MEDICINE_FOOD)));
    public static final Item ICED_AMERICANO = registerItems("iced_americano", new MedicineFoodItem(new Item.Settings().food(MedicineFoodComponents.MEDICINE_FOOD)));
    public static final Item COCONUT_LATTE = registerItems("coconut_latte", new MedicineFoodItem(new Item.Settings().food(MedicineFoodComponents.MEDICINE_FOOD)));
    public static final Item MOCHA_COFFEE = registerItems("mocha_coffee", new MedicineFoodItem(new Item.Settings().food(MedicineFoodComponents.MEDICINE_FOOD)));
    public static final Item WEIRD_BLACK_TEA = registerItems("weird_black_tea", new MedicineFoodItem(new Item.Settings().food(MedicineFoodComponents.MEDICINE_FOOD)));
    public static final Item MINERAL_WATER = registerItems("mineral_water", new MedicineFoodItem(new Item.Settings().food(MedicineFoodComponents.MEDICINE_FOOD)));
    public static final Item ICED_MINERAL_WATER = registerItems("iced_mineral_water", new MedicineFoodItem(new Item.Settings().food(MedicineFoodComponents.MEDICINE_FOOD)));
    public static final Item INSTANT_NOODLES = registerItems("instant_noodles", new MedicineFoodItem(new Item.Settings().food(MedicineFoodComponents.MEDICINE_FOOD)));
    public static final Item LEMON_WATER = registerItems("lemon_water", new MedicineFoodItem(new Item.Settings().food(MedicineFoodComponents.MEDICINE_FOOD)));
    public static final Item COCONUT_TEA_JELLY = registerItems("coconut_tea_jelly", new MedicineFoodItem(new Item.Settings().food(MedicineFoodComponents.MEDICINE_FOOD)));
    public static final Item MATCHA_LUCKY_ICE = registerItems("matcha_lucky_ice", new MedicineFoodItem(new Item.Settings().food(MedicineFoodComponents.MEDICINE_FOOD)));
    public static final Item PLUM_WINE = registerItems("plum_wine", new MedicineFoodItem(new Item.Settings().food(MedicineFoodComponents.MEDICINE_FOOD)));
    public static final Item CREAM_CAKE = registerItems("cream_cake", new MedicineFoodItem(new Item.Settings().food(MedicineFoodComponents.MEDICINE_FOOD)));
    public static final Item STRAWBERRY_CAKE = registerItems("strawberry_cake", new MedicineFoodItem(new Item.Settings().food(MedicineFoodComponents.MEDICINE_FOOD)));
    public static final Item ORANGE_CAKE = registerItems("orange_cake", new MedicineFoodItem(new Item.Settings().food(MedicineFoodComponents.MEDICINE_FOOD)));
    public static final Item BOX_OF_STRAWBERRIES = registerItems("box_of_strawberries", new MedicineFoodItem(new Item.Settings().food(MedicineFoodComponents.MEDICINE_FOOD)));
    public static final Item NO_11_STREET_DRIP_COFFEE = registerItems("no_11_street_drip_coffee", new MedicineFoodItem(new Item.Settings().food(MedicineFoodComponents.MEDICINE_FOOD)));
    public static final Item BAGGED_GRAPE_COOKIES = registerItems("bagged_grape_cookies", new MedicineFoodItem(new Item.Settings().food(MedicineFoodComponents.MEDICINE_FOOD)));
    public static final Item BAGGED_CREAM_COOKIES = registerItems("bagged_cream_cookies", new MedicineFoodItem(new Item.Settings().food(MedicineFoodComponents.MEDICINE_FOOD)));
    public static final Item BAGGED_WATERMELON_COOKIES = registerItems("bagged_watermelon_cookies", new MedicineFoodItem(new Item.Settings().food(MedicineFoodComponents.MEDICINE_FOOD)));
    public static final Item BAGGED_ORANGE_COOKIES = registerItems("bagged_orange_cookies", new MedicineFoodItem(new Item.Settings().food(MedicineFoodComponents.MEDICINE_FOOD)));
    public static final Item BAGGED_PINEAPPLE_COOKIES = registerItems("bagged_pineapple_cookies", new MedicineFoodItem(new Item.Settings().food(MedicineFoodComponents.MEDICINE_FOOD)));
    public static final Item BAGGED_BLUEBERRY_COOKIES = registerItems("bagged_blueberry_cookies", new MedicineFoodItem(new Item.Settings().food(MedicineFoodComponents.MEDICINE_FOOD)));
    public static final Item BAGGED_MINT_COOKIES = registerItems("bagged_mint_cookies", new MedicineFoodItem(new Item.Settings().food(MedicineFoodComponents.MEDICINE_FOOD)));
    public static final Item RAW_FISH_KING = registerItems("raw_fish_king", new MedicineFoodItem(new Item.Settings().food(MedicineFoodComponents.MEDICINE_FOOD)));
    public static final Item COOKED_FISH_KING = registerItems("cooked_fish_king", new MedicineFoodItem(new Item.Settings().food(MedicineFoodComponents.MEDICINE_FOOD)));
    public static final Item FROZEN_RAW_FISH_KING = registerItems("frozen_raw_fish_king", new MedicineFoodItem(new Item.Settings().food(MedicineFoodComponents.MEDICINE_FOOD)));
    public static final Item FROZEN_COOKED_FISH_KING = registerItems("frozen_cooked_fish_king", new MedicineFoodItem(new Item.Settings().food(MedicineFoodComponents.MEDICINE_FOOD)));
    ...
    public static final Item VIAL_OF_STRANGE_LIQUID = registerItems("vial_of_strange_liquid", new MedicineFoodItem(new Item.Settings().food(MedicineFoodComponents.MEDICINE_FOOD)));
    public static final Item GOLD_RING = registerItems("gold_ring", new Item(new Item.Settings()));
    public static final Item GOLDEN_FISH = registerItems("golden_fish", new MedicineFoodItem(new Item.Settings().rarity(UNCOMMON).food(MedicineFoodComponents.MEDICINE_FOOD)));
