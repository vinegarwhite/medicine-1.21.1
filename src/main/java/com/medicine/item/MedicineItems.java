...
public class MedicineItems {
    ...
    public static final Item THICK_EGG_TOAST = registerItems("thick_egg_toast", new MedicineFoodItem(new Item.Settings().food(MedicineFoodComponents.MEDICINE_FOOD_COMMON)));
    ...
    public static final Item VEGGIE_SALAD = registerItems("veggie_salad", new MedicineFoodItem(new Item.Settings().food(MedicineFoodComponents.MEDICINE_FOOD_COMMON)));
    public static final Item SAUSAGE_PIZZA = registerItems("sausage_pizza", new MedicineFoodItem(new Item.Settings().food(MedicineFoodComponents.MEDICINE_FOOD_COMMON)));
    public static final Item BEEF_BURGER = registerItems("beef_burger", new MedicineFoodItem(new Item.Settings().food(MedicineFoodComponents.MEDICINE_FOOD_COMMON)));
    public static final Item CAESAR_BREAD = registerItems("caesar_bread", new MedicineFoodItem(new Item.Settings().food(MedicineFoodComponents.MEDICINE_FOOD_COMMON)));
    public static final Item TOMATO_PASTA = registerItems("tomato_pasta", new MedicineFoodItem(new Item.Settings().food(MedicineFoodComponents.MEDICINE_FOOD_COMMON)));
    public static final Item SALMON_SOUP = registerItems("salmon_soup", new MedicineFoodItem(new Item.Settings().food(MedicineFoodComponents.MEDICINE_FOOD_COMMON)));
    public static final Item TOMAHAWK_STEAK = registerItems("tomahawk_steak", new MedicineFoodItem(new Item.Settings().food(MedicineFoodComponents.MEDICINE_FOOD_COMMON)));
    public static final Item BAGGED_CHESTNUTS = registerItems("bagged_chestnuts", new MedicineFoodItem(new Item.Settings().food(MedicineFoodComponents.MEDICINE_FOOD_COMMON)));
    public static final Item FRIED_CRISPY_MEAT = registerItems("fried_crispy_meat", new MedicineFoodItem(new Item.Settings().food(MedicineFoodComponents.MEDICINE_FOOD_COMMON)));
    public static final Item GRILLED_COLD_NOODLES = registerItems("grilled_cold_noodles", new MedicineFoodItem(new Item.Settings().food(MedicineFoodComponents.MEDICINE_FOOD_COMMON)));
    public static final Item PINEAPPLE_ON_A_STICK = registerItems("pineapple_on_a_stick", new MedicineFoodItem(new Item.Settings().food(MedicineFoodComponents.MEDICINE_FOOD_COMMON)));
    ...
    public static final Item INSTANT_NOODLES = registerItems("instant_noodles", new MedicineFoodItem(new Item.Settings().food(MedicineFoodComponents.MEDICINE_FOOD_COMMON)));
    ...
    public static final Item CREAM_CAKE = registerItems("cream_cake", new MedicineFoodItem(new Item.Settings().food(MedicineFoodComponents.MEDICINE_FOOD_COMMON)));
    public static final Item STRAWBERRY_CAKE = registerItems("strawberry_cake", new MedicineFoodItem(new Item.Settings().food(MedicineFoodComponents.MEDICINE_FOOD_COMMON)));
    public static final Item ORANGE_CAKE = registerItems("orange_cake", new MedicineFoodItem(new Item.Settings().food(MedicineFoodComponents.MEDICINE_FOOD_COMMON)));
    public static final Item BOX_OF_STRAWBERRIES = registerItems("box_of_strawberries", new MedicineFoodItem(new Item.Settings().food(MedicineFoodComponents.MEDICINE_FOOD_COMMON)));
    ...
    public static final Item BAGGED_GRAPE_COOKIES = registerItems("bagged_grape_cookies", new MedicineFoodItem(new Item.Settings().food(MedicineFoodComponents.MEDICINE_FOOD_COMMON)));
    public static final Item BAGGED_CREAM_COOKIES = registerItems("bagged_cream_cookies", new MedicineFoodItem(new Item.Settings().food(MedicineFoodComponents.MEDICINE_FOOD_COMMON)));
    public static final Item BAGGED_WATERMELON_COOKIES = registerItems("bagged_watermelon_cookies", new MedicineFoodItem(new Item.Settings().food(MedicineFoodComponents.MEDICINE_FOOD_COMMON)));
    public static final Item BAGGED_ORANGE_COOKIES = registerItems("bagged_orange_cookies", new MedicineFoodItem(new Item.Settings().food(MedicineFoodComponents.MEDICINE_FOOD_COMMON)));
    public static final Item BAGGED_PINEAPPLE_COOKIES = registerItems("bagged_pineapple_cookies", new MedicineFoodItem(new Item.Settings().food(MedicineFoodComponents.MEDICINE_FOOD_COMMON)));
    public static final Item BAGGED_BLUEBERRY_COOKIES = registerItems("bagged_blueberry_cookies", new MedicineFoodItem(new Item.Settings().food(MedicineFoodComponents.MEDICINE_FOOD_COMMON)));
    public static final Item BAGGED_MINT_COOKIES = registerItems("bagged_mint_cookies", new MedicineFoodItem(new Item.Settings().food(MedicineFoodComponents.MEDICINE_FOOD_COMMON)));
    public static final Item RAW_FISH_KING = registerItems("raw_fish_king", new MedicineFoodItem(new Item.Settings().food(MedicineFoodComponents.MEDICINE_FOOD_COMMON)));
    public static final Item COOKED_FISH_KING = registerItems("cooked_fish_king", new MedicineFoodItem(new Item.Settings().food(MedicineFoodComponents.MEDICINE_FOOD_COMMON)));
    public static final Item FROZEN_RAW_FISH_KING = registerItems("frozen_raw_fish_king", new MedicineFoodItem(new Item.Settings().food(MedicineFoodComponents.MEDICINE_FOOD_COMMON)));
    public static final Item FROZEN_COOKED_FISH_KING = registerItems("frozen_cooked_fish_king", new MedicineFoodItem(new Item.Settings().food(MedicineFoodComponents.MEDICINE_FOOD_COMMON)));
    ...
    public static final Item GOLDEN_FISH = registerItems("golden_fish", new MedicineFoodItem(new Item.Settings().rarity(UNCOMMON).food(MedicineFoodComponents.MEDICINE_FOOD_COMMON)));
